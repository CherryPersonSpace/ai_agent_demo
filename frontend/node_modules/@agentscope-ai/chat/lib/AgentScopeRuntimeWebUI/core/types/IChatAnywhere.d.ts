...
export interface IAgentScopeRuntimeWebUISenderOptions {
     ...
     */
    characterCountRender?: (info: IAgentScopeRuntimeWebUISenderActionInfo) => React.ReactNode;
    /**
     ...
     */
    actionAffix?: React.ReactNode | ((info: IAgentScopeRuntimeWebUISenderActionInfo) => React.ReactNode);
    /**
     * @description 输入框前置UI
