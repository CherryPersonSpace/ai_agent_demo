...
function Block(props) {
  ...
  var _useState3 = useState(expandEnabled === true ? false : true),
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      className: "".concat(prefixCls, "-tool-call-block-header"),
      ...
      children: [/*#__PURE__*/_jsx("span", {
        ...
        className: "".concat(prefixCls, "-tool-call-block-extra"),
        ...
        children: /*#__PURE__*/_jsx(IconButton, {
          ...
          bordered: false,
          onClick: function onClick() {
            copy(contentString).then(function () {
...
export default function (props) {
  var _props$inputBlock, _props$outputBlock;
