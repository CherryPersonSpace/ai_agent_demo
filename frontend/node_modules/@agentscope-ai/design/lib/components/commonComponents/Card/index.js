...
var _excluded = ["title", "info", "children", "className"];
...
export default (function (props) {
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsx(Style, {}), /*#__PURE__*/_jsx(Card, _objectSpread(_objectSpread({
      className: classNames("".concat(sparkPrefix, "-card"), className)
    }, restProps), {}, {
      title: null,
