...
import '../index.css';
export default function SparkAgentTabFill(props) {
  const { size, spin, ...restProps } = props;
  const icon = 'spark-icon spark-icon-spark-agentTab-fill';
  const className = [
    icon,
  ...
  return React.createElement('span', Object.assign({}, restProps, {
    ...
    role: 'img',
    'aria-label': 'spark-agentTab-fill',
    'data-spark-icon': true, // 标识为 spark-icon 组件
    children: [
      React.createElement('svg', Object.assign({
        key: 'spark-agentTab-fill',
        width: '1em',
        height: '1em',
