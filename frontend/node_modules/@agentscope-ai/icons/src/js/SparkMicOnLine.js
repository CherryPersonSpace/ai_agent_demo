...
import '../index.css';
export default function SparkMicOnLine(props) {
  const { size, spin, ...restProps } = props;
  const icon = 'spark-icon spark-icon-spark-micOn-line';
  const className = [
    icon,
  ...
  return React.createElement('span', Object.assign({}, restProps, {
    ...
    role: 'img',
    'aria-label': 'spark-micOn-line',
    'data-spark-icon': true, // 标识为 spark-icon 组件
    children: [
      React.createElement('svg', Object.assign({
        key: 'spark-micOn-line',
        width: '1em',
        height: '1em',
