...
import '../index.css';
export default function SparkProductServiceLine(props) {
  const { size, spin, ...restProps } = props;
  const icon = 'spark-icon spark-icon-spark-productService-line';
  const className = [
    icon,
  ...
  return React.createElement('span', Object.assign({}, restProps, {
    ...
    role: 'img',
    'aria-label': 'spark-productService-line',
    'data-spark-icon': true, // 标识为 spark-icon 组件
    children: [
      React.createElement('svg', Object.assign({
        key: 'spark-productService-line',
        width: '1em',
        height: '1em',
